...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descricao = "A ATM Consultoria tem como missão apoiar as organizações " +
                "que desejam alcançar o sucesso através da excelência em gestão" +
                " da busca pela informação";
        ...
        return new AboutPage( getActivity() )
                ...
                .addFacebook("Grillo.Guillardi", "Facebook")
                .addInstagram("grillo_guillardi", "Instagram")
                .addGitHub("JoseGu1llardi", "GitHub")
